...
describe('LinkButton', () => {
  ...
  describe('icon', () => {
    it('sets the correct icon', () => {
      const button = shallow(<LinkButton href="#" icon="add-circle">link button</LinkButton>);
      expect(button.find('Icon').prop('name')).toBe('add-circle');
    });
    it('sets the correct icon size', () => {
      const button = shallow(<LinkButton href="#" icon="add-circle" size="large">link button</LinkButton>);
    ...
    it('positions the icon on the right side', () => {
      const button = shallow(<LinkButton href="#" icon="add-circle" iconAfterText>link button</LinkButton>);
