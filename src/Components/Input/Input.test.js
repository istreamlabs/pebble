...
describe('Input', () => {
  ...
  describe('getInputProps', () => {
    ...
    it('size small styles get set', () => {
      const wrapper = shallow(<Input size="small" label="test label" />);
      expect(wrapper.find('input').prop('className')).toContain('input-s');
    });

    it('size large styles get set', () => {
      const wrapper = shallow(<Input size="large" label="test label" />);
      expect(wrapper.find('input').prop('className')).toContain('input-l');
    });

    it('read only sizes get set', () => {
      const wrapper = shallow(<Input isReadOnly label="test label" />);
      expect(wrapper.find('input').prop('className')).toContain('bg-neutral-200');
    });
